...
interface I_IdentityManager_Nine {
...
// =====================================================================================================
contract IdentityManager_Nine is I_IdentityManager_Nine {
  ...
  // Configure multi-sign transaction 
    ...
    uint8 private constant MIN_SIG_REQUIRED = 5;     
  // Structure of object
  struct _obj{
    string      name;
    string      idType;
...
- succeed!!! 
- Some test cases throw errors: Not enough signatures to execute transaction   
- This proves that contract works as update
*/
